...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F6F5F2] dark:bg-[#121214] text-[#161519] dark:text-[#F6F5F2] transition-colors duration-200 selection:bg-[#E11D2A] selection:text-white">
      {/* Accessible skip link for keyboard users (WCAG AA requirement) */}
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-3 focus:left-3 focus:z-50 px-4 py-2 bg-[#E11D2A] text-white rounded-full font-semibold text-sm shadow-md"
      >
