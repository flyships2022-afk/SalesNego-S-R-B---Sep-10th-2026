  ...
  return (
    <div className="w-full flex flex-col bg-[#F6F5F2] dark:bg-[#121214] text-[#161519] dark:text-white transition-colors">
      ...
      <section
        ...
        className="relative overflow-hidden w-full pt-12 pb-14 md:pt-16 md:pb-20 border-b border-[#E5E3DC] dark:border-white/10"
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="text-xs md:text-sm font-semibold uppercase tracking-wider text-[#EE2338] block mb-3">
              LEGAL &amp; COMPLIANCE
            </span>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#161519] dark:text-white mb-4 leading-tight">
              Privacy Policy
            </h1>
      ...
      <section
        ...
        className="w-full py-16 bg-white dark:bg-[#161519]"
      >
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
          <div className="p-4 rounded-2xl bg-[#F6F5F2] dark:bg-[#1C1B20] border border-[#E5E3DC] dark:border-white/10 flex items-center gap-3">
            <ShieldCheck className="w-5 h-5 text-[#EE2338] shrink-0" />
          ...
          <div>
            <h2 className="text-lg font-bold text-[#161519] dark:text-white mb-2">
          ...
          <div>
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-[#EE2338] hover:underline"
              >
